                  ...
                  <div class="card mb-4">
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" value=""><?php echo $row['name']?></p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" value=""><?php echo $row['number']?></p>
                        </div>
                      </div>
                      <hr>
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" value=""><?php echo $row['email']?></p>
                        </div>
                      </div>
                      <hr>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-9">
                          <p class="text-muted mb-0" value=""><?php echo $row['password']?></p>
                        </div>
                      </div>
                    </div>
                 </div>
